            ...
            <div class="col-md-3"></div>
                <div class="col-md-6 ftco-animate">
                    ...
                    <form method="POST" action="add.php" class="contact-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input name="size-ml" type="number" step="1" class="form-control" placeholder="Mărime(ml)*" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input name="new-drink" type="submit" value="Adăugare" class="btn btn-primary py-3 px-5">
                        </div>
                    </form>
                </div>
            </div>
